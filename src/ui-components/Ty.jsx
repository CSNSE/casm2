  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children="You have successfully submitted your responses!"
            {...getOverrideProps(
              overrides,
      ...
      <Text
        ...
        padding="0px 0px 0px 0px"
        whiteSpace="pre-wrap"
        children="Thank you for taking time out of your busy schedule to answer this survey. Your Response is valued!"
